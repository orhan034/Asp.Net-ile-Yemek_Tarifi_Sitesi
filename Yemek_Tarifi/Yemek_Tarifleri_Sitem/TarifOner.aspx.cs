...
public partial class TarifOner : System.Web.UI.Page
{
    ...
    {
        SqlCommand komut = new SqlCommand("insert into Tbl_Tarifler (TarifAd, TarifMalzame, TarifYapilis, TarifResim, TarifSahip, TarifSahipMail) Values (@t1,@t2,@t3,@t4,@t5,@t6)", bgl.baglanti());
        komut.Parameters.AddWithValue("@t1", TxtTarifAd.Text);
        komut.Parameters.AddWithValue("@t2", TxtMalzame.Text);
